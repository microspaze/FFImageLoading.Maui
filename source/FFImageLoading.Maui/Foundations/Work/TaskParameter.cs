...
namespace FFImageLoading.Work
{
    public class TaskParameter : IDisposable
    {
        ...
        {
            return new TaskParameter() { SourceType = ImageSourceType.Filepath, Path = filepath };
        }
		...
		public static TaskParameter FromEmbeddedResource(string resourceUri)
        {
            ...
            return new TaskParameter() { SourceType = ImageSourceType.EmbeddedResource, Path = resourceUri };
        }
        ...
        {
            return new TaskParameter() { SourceType = ImageSourceType.Url, Path = url, CacheDuration = cacheDuration };
        }
        ...
        {
            var taskParameter = new TaskParameter() { SourceType = ImageSourceType.ApplicationBundle, Path = filePath };
        ...
        {
            var taskParameter = new TaskParameter() { SourceType = ImageSourceType.CompiledResource, Path = resourceName };
        ...
        {
            return new TaskParameter() { SourceType = ImageSourceType.Stream, Stream = stream };
        }
        ...
        {
            return new TaskParameter() { SourceType = ImageSourceType.Url, Path = data, DataEncoding = encoding };
        }
		...
		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public ImageSourceType LoadingPlaceholderSourceType { get; private set; }

		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public string LoadingPlaceholderPath { get; private set; }

		[EditorBrowsable(EditorBrowsableState.Advanced)]
		public ImageSourceType ErrorPlaceholderSourceType { get; private set; }
        ...
        /// <param name="sourceType">Source for the path: local, web, assets</param>
        public TaskParameter LoadingPlaceholder(string path, ImageSourceType sourceType = ImageSourceType.Filepath)
        {
            LoadingPlaceholderPath = path;
            LoadingPlaceholderSourceType = sourceType;
            return this;
        }
        ...
        /// <param name="filepath">Path to the file.</param>
        /// <param name="sourceType">Source for the path: local, web, assets</param>
        public TaskParameter ErrorPlaceholder(string filepath, ImageSourceType sourceType = ImageSourceType.Filepath)
        {
            ErrorPlaceholderPath = filepath;
            ErrorPlaceholderSourceType = sourceType;
            return this;
        }
