...
namespace FFImageLoading.Transformations
{
    ...
    public class TintTransformation : ColorSpaceTransformation
    {
        ...
        protected override Bitmap Transform(Bitmap sourceBitmap, string path, Work.ImageSourceType sourceType, bool isPlaceholder, string key)
        {
            if (EnableSolidColor)
            ...
            return base.Transform(sourceBitmap, path, sourceType, isPlaceholder, key);
        }
