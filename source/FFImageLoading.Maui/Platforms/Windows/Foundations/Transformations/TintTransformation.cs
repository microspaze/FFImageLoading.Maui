...
namespace FFImageLoading.Transformations
{
    public class TintTransformation : ColorSpaceTransformation
    {
        ...
        protected override BitmapHolder Transform(BitmapHolder bitmapSource, string path, Work.ImageSourceType sourceType, bool isPlaceholder, string key)
        {
            if (EnableSolidColor)
            {
            ...
            return base.Transform(bitmapSource, path, sourceType, isPlaceholder, key);
        }
